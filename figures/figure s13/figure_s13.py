...
def figure():
    ...
    # OS Cwd
    path = os.getcwd()+"\\figures\\figure s13\\"
    ...
    ax2 = fig.plot_pdf(rect_a,path+"PDF\\figure_s13a.pdf")
    ...
    # FEM Data
    df = fig.load_csv(os.getcwd()+'\\data\\FEM_cylinderical_PBC\\Validation\\stress.csv')
    strain = df.iloc[:, 0]
    stress = df.iloc[:, 1]
    ...
    # Saving of figure
    fig.savefig(path + 'figure_s13.pdf', dpi=800)
